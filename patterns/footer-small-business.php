 ...
 * Slug: pulp/footer-small-business
 * Categories: footer
...
<div class="wp-block-group alignfull" style="margin-top:0px;padding-top:var(--wp--preset--spacing--x-large);padding-right:30px;padding-bottom:var(--wp--preset--spacing--x-large);padding-left:30px">
	...
	<div class="wp-block-columns alignwide" style="margin-top:var(--wp--preset--spacing--large)">
		...
		<div class="wp-block-column" style="flex-basis:40%">
			...
			<h3 class="wp-block-heading has-text-color has-tiny-font-size" style="color:#525252;text-transform:uppercase"><?php echo esc_html__( 'Main Office', 'pulp' ); ?></h3>
			<!-- /wp:heading -->
		...
		<div class="wp-block-column" style="flex-basis:60%">
			...
			<div class="wp-block-columns">
				...
				<div class="wp-block-column">
					<!-- wp:heading {"level":3,"style":{"typography":{"textTransform":"uppercase"},"color":{"text":"#525252"}},"fontSize":"tiny"} -->
					<h3 class="wp-block-heading has-text-color has-tiny-font-size" style="color:#525252;text-transform:uppercase">Sydney</h3>
					<!-- /wp:heading -->
					<!-- wp:list {"style":{"typography":{"lineHeight":"1.5"}},"className":"is-style-no-style","fontSize":"small"} -->
					<ul style="line-height:1.5" class="is-style-no-style has-small-font-size">
						<!-- wp:list-item -->
				...
				<div class="wp-block-column">
					<!-- wp:heading {"level":3,"style":{"typography":{"textTransform":"uppercase"},"color":{"text":"#525252"}},"fontSize":"tiny"} -->
					<h3 class="wp-block-heading has-text-color has-tiny-font-size" style="color:#525252;text-transform:uppercase">Perth</h3>
					<!-- /wp:heading -->
					<!-- wp:list {"style":{"typography":{"lineHeight":"1.5"}},"className":"is-style-no-style","fontSize":"small"} -->
					<ul style="line-height:1.5" class="is-style-no-style has-small-font-size">
						<!-- wp:list-item -->
				...
				<div class="wp-block-column">
					<!-- wp:heading {"level":3,"style":{"typography":{"textTransform":"uppercase"},"color":{"text":"#525252"}},"fontSize":"tiny"} -->
					<h3 class="wp-block-heading has-text-color has-tiny-font-size" style="color:#525252;text-transform:uppercase">Tasmania</h3>
					<!-- /wp:heading -->
					<!-- wp:list {"style":{"typography":{"lineHeight":"1.5"}},"className":"is-style-no-style","fontSize":"small"} -->
					<ul style="line-height:1.5" class="is-style-no-style has-small-font-size">
						<!-- wp:list-item -->

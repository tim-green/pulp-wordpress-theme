 ...
 * Slug: pulp/team-single-text-image-dark
...
<div class="wp-block-group alignfull has-base-color has-contrast-background-color has-text-color has-background has-link-color" style="margin-top:0;padding-top:var(--wp--preset--spacing--x-large);padding-right:30px;padding-bottom:var(--wp--preset--spacing--x-large);padding-left:30px">
	...
	<div class="wp-block-columns are-vertically-aligned-center">
		...
		<div class="wp-block-column is-vertically-aligned-center">
			...
			<h2 class="wp-block-heading has-x-large-font-size"><?php echo esc_html__( 'Jennifer Kayne', 'pulp' ); ?></h2>
			<!-- /wp:heading -->
			<!-- wp:paragraph {"style":{"spacing":{"margin":{"top":"5px"}}},"fontSize":"x-small"} -->
			<p class="has-x-small-font-size" style="margin-top:5px"><?php echo esc_html__( 'Chief Executive Officer', 'pulp' ); ?></p>
			<!-- /wp:paragraph -->
			<!-- wp:paragraph -->
			<p><?php echo esc_html__( 'Growing up under the sunny skies of Australia, she infuses her coastal upbringing into her role as a creative leader at a cutting-edge design studio, where she specializes in distinctive branding and digital innovation.', 'pulp' ); ?></p>
			<!-- /wp:paragraph -->

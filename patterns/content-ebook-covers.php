 ...
 * Slug: pulp/content-ebook-covers
 * Categories: pulp-content
 */
?>
<!-- wp:group {"metadata":{"name":"eBook Covers"},"align":"full","style":{"spacing":{"padding":{"top":"var:preset|spacing|x-large","bottom":"var:preset|spacing|x-large","left":"30px","right":"30px"},"margin":{"top":"0"}}},"layout":{"type":"constrained"}} -->

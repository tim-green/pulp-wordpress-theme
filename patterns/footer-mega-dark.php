...
<div class="wp-block-group alignfull has-base-color has-contrast-background-color has-text-color has-background has-link-color has-x-small-font-size" style="margin-top:0;padding-top:var(--wp--preset--spacing--x-large);padding-right:30px;padding-bottom:var(--wp--preset--spacing--x-large);padding-left:30px">
	...
	<div class="wp-block-group alignwide" style="padding-bottom:var(--wp--preset--spacing--medium)">
		...
		<figure class="wp-block-image aligncenter size-full is-resized"><a href="#/"><img src="<?php echo esc_url( get_template_directory_uri() ) . '/assets/images/site-logo-light.svg'; ?>" alt="pulp site logo" width="40" height="40"/></a></figure>
		<!-- /wp:image -->
		...
		<div class="wp-block-columns are-vertically-aligned-center">
			...
			<div class="wp-block-column is-vertically-aligned-center" style="flex-basis:30%">
				...
				<div class="wp-block-buttons">
					...
					<div class="wp-block-button aligncenter"><a class="wp-block-button__link has-contrast-color has-base-background-color has-text-color has-background has-link-color wp-element-button" href="#"><?php echo esc_html__( 'Call to Action', 'pulp' ); ?></a></div>
					<!-- /wp:button -->
				</div>
				<!-- /wp:buttons -->
			</div>

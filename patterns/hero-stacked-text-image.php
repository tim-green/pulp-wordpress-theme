 ...
 * Slug: pulp/hero-stacked-text-image
 * Categories: pulp-hero
 */
?>
<!-- wp:group {"metadata":{"name":"Text and Image"},"align":"full","style":{"spacing":{"blockGap":"0px","padding":{"top":"var:preset|spacing|medium"},"margin":{"top":"0"}}},"layout":{"type":"constrained","wideSize":"800px"}} -->

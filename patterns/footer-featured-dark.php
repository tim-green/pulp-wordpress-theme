 ...
 * Slug: pulp/footer-featured-dark
 * Categories: footer
 * Block Types: core/template-part/footer
 */
?>
<!-- wp:group {"align":"full","style":{"spacing":{"margin":{"top":"0"},"padding":{"right":"30px","left":"30px","top":"var:preset|spacing|large","bottom":"var:preset|spacing|small"},"blockGap":"var:preset|spacing|x-large"},"elements":{"link":{"color":{"text":"var:preset|color|base"}}}},"backgroundColor":"contrast","textColor":"base","layout":{"type":"constrained"}} -->
<div class="wp-block-group alignfull has-base-color has-contrast-background-color has-text-color has-background has-link-color" style="margin-top:0;padding-top:var(--wp--preset--spacing--large);padding-right:30px;padding-bottom:var(--wp--preset--spacing--small);padding-left:30px">
...
<p class="has-tiny-font-size" style="font-style:normal;font-weight:400;text-transform:uppercase"><?php echo esc_html__( 'Meet Pulp', 'pulp' ); ?></p>
					<!-- /wp:paragraph -->
				</div>
				<!-- /wp:group -->
				<!-- wp:heading {"fontSize":"max-60"} -->
				<h2 class="wp-block-heading has-max-60-font-size"><?php echo esc_html__( 'Are you ready to begin designing with WordPress??', 'pulp' ); ?></h2>
				<!-- /wp:heading -->
				...
				<div class="wp-block-buttons" style="margin-top:var(--wp--preset--spacing--small)">
					...
					<div class="wp-block-button is-style-outline"><a class="wp-block-button__link wp-element-button"><?php echo esc_html__( 'Learn More', 'pulp' ); ?></a></div>
					<!-- /wp:button -->
				</div>
				<!-- /wp:buttons -->
			</div>
		...
		<div class="wp-block-column is-vertically-aligned-center" style="flex-basis:320px">
			...
			<figure class="wp-block-image size-full is-resized"><img src="<?php echo esc_url( get_template_directory_uri() ) . '/assets/images/sample-image-light.svg'; ?>" alt="Sample image" style="object-fit:cover;width:320px;height:320px" width="320" height="320"/></figure>
			<!-- /wp:image -->
		</div>
		<!-- /wp:column -->
	</div>

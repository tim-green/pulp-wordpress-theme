 ...
 * Slug: pulp/hero-text-button-dark
 * Categories: pulp-hero
 */
?>
<!-- wp:group {"metadata":{"name":"Text and Button"},"align":"full","style":{"spacing":{"padding":{"top":"var:preset|spacing|x-large","bottom":"var:preset|spacing|x-large","left":"30px","right":"30px"},"margin":{"top":"0"}},"elements":{"link":{"color":{"text":"var:preset|color|base"}}}},"backgroundColor":"contrast","textColor":"base","layout":{"type":"constrained","wideSize":"800px"}} -->
<div class="wp-block-group alignfull has-base-color has-contrast-background-color has-text-color has-background has-link-color" style="margin-top:0;padding-top:var(--wp--preset--spacing--x-large);padding-right:30px;padding-bottom:var(--wp--preset--spacing--x-large);padding-left:30px">
	...
	<div class="wp-block-group">
		...
		<h1 class="wp-block-heading has-text-align-center has-max-72-font-size"><?php echo esc_html__( 'Are you ready to design with WordPress?', 'pulp' ); ?></h1>
		<!-- /wp:heading -->
		<!-- wp:paragraph {"align":"center"} -->
		<p class="has-text-align-center"><?php echo esc_html__( 'Redefine your space with a stylish, modern design.', 'pulp' ); ?></p>
		<!-- /wp:paragraph -->
	</div>
	<!-- /wp:group -->

 ...
 * Slug: pulp/pricing-2-columns
 * Categories: pulp-pricing
 */
?>
<!-- wp:group {"metadata":{"name":"Pricing Table"},"align":"full","style":{"spacing":{"padding":{"right":"30px","left":"30px","top":"var:preset|spacing|x-large","bottom":"var:preset|spacing|x-large"},"margin":{"top":"0"}}},"layout":{"type":"constrained","wideSize":"840px"}} -->

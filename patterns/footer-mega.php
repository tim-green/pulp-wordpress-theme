 ...
 * Slug: pulp/footer-mega
 * Categories: footer
 * Block Types: core/template-part/footer
 */
?>
<!-- wp:group {"align":"full","style":{"spacing":{"margin":{"top":"0"},"padding":{"top":"var:preset|spacing|x-large","bottom":"var:preset|spacing|x-large","right":"30px","left":"30px"},"blockGap":"0px"}},"layout":{"type":"constrained"},"fontSize":"x-small"} -->
<div class="wp-block-group alignfull has-x-small-font-size" style="margin-top:0;padding-top:var(--wp--preset--spacing--x-large);padding-right:30px;padding-bottom:var(--wp--preset--spacing--x-large);padding-left:30px">
	...
	<div class="wp-block-group alignwide" style="padding-bottom:var(--wp--preset--spacing--medium)">
		...
		<figure class="wp-block-image aligncenter size-full is-resized"><a href="#/"><img src="<?php echo esc_url( get_template_directory_uri() ) . '/assets/images/site-logo-dark.svg'; ?>" alt="pulp site logo" width="40" height="40"/></a></figure>
		<!-- /wp:image -->
		<!-- wp:paragraph {"align":"center"} -->
		<p class="has-text-align-center"><?php echo esc_html__( 'Made with Pulp', 'pulp' ); ?></p>
		<!-- /wp:paragraph -->
	</div>
	<!-- /wp:group -->
		...
		<div class="wp-block-columns are-vertically-aligned-center">
			...
			<div class="wp-block-column is-vertically-aligned-center" style="flex-basis:30%">
				...
				<div class="wp-block-buttons">
					...
					<div class="wp-block-button aligncenter"><a class="wp-block-button__link wp-element-button" href="#"><?php echo esc_html__( 'Call to Action', 'pulp' ); ?></a></div>
					<!-- /wp:button -->
				</div>
				<!-- /wp:buttons -->
			</div>
			...
			<div class="wp-block-column is-vertically-aligned-center" style="flex-basis:40%">
				...
				<div class="wp-block-group" style="border-right-color:#e5e5e5;border-left-color:#e5e5e5">
					<!-- wp:paragraph {"align":"center"} -->
					<p class="has-text-align-center"><?php echo esc_html__( '“If you can imagine it, you can achieve it. If you can dream it, you can become it.”', 'pulp' ); ?></p>
					<!-- /wp:paragraph -->
					<!-- wp:paragraph {"align":"center"} -->
					<p class="has-text-align-center">—William Arthur Ward </p>
					<!-- /wp:paragraph -->
				</div>
				<!-- /wp:group -->
			</div>
